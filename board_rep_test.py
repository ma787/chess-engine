...
class TestMoveMaking(unittest.TestCase):
    def test_convert_lan_to_move(self):
        ...
        self.assertIsNone(b.new_game.convert_lan_to_move("gedfvfew"))
        self.assertIsNone(b.new_game.convert_lan_to_move("Pe4xe5Q"))

        test_class_1 = b.new_game.convert_lan_to_move("e4-e5")
        ...
        test_class_2 = b.new_game.convert_lan_to_move("0-0")
        ...
        test_class_3 = b.new_game.convert_lan_to_move("d2-d8Q")
        ...
        test_class_4 = b.new_game.convert_lan_to_move("0-0-0")
        ...
        self.assertEqual(test_attributes_4, [b.game_board.array[0][4], b.King, b.Colour.WHITE, (0, 4), (0, 2),
