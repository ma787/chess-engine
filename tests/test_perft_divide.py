...
class TestPerftDivide(unittest.TestCase):
    ...
    def test_perft_1_from_ep_pinned_pawn_by_rook_equals_16(self):
        # ARRANGE
        test_board = fp.fen_to_board("8/2p5/3p4/KP5r/1R2Pp1k/8/6P1/8 b - e3 0 1")
    ...
    def test_perft_1_from_bishop_check_position_equals_7(self):
        # ARRANGE
        test_board = fp.fen_to_board(
            "r3k2r/p1ppqpb1/bn2pnp1/3PN3/1p2P3/2N2Q1p/PPPBKPPP/R4B1R w kq - 4 3"
        )
    ...
    def test_perft_1_from_queen_check_position_equals_8(self):
        # ARRANGE
        test_board = fp.fen_to_board(
    ...
    def test_perft_1_from_check_with_ep_capture_possible_equals_7(self):
        # ARRANGE
        test_board = fp.fen_to_board("8/8/3p4/1Pp4r/1K3R2/6k1/4P1P1/8 w - c6 0 3")
    ...
    def test_perft_1_from_check_with_illegal_knight_block_equals_4(self):
        # ARRANGE
        test_board = fp.fen_to_board(
            "r2k3Q/p1pp1pb1/bn2pnp1/2qPN1B1/1p2P3/2N4p/PPP1BPPP/R3K2R b KQ - 0 3"
        )
    ...
    def test_perft_1_from_check_with_knight_protecting_checker_equals_3(self):
        # ARRANGE
        test_board = fp.fen_to_board(
            "r3k2r/p1pq1Pb1/bn1p1np1/1B2N3/1p2P3/2N2Q1p/PPPB1PPP/R3K2R b KQkq - 0 3"
        )
    ...
    def test_perft_1_from_pinned_black_pawn_position_equals_20(self):
        # ARRANGE
        test_board = fp.fen_to_board("8/2p5/3p4/KP3R1r/5p2/8/4PkP1/8 b - - 5 3")
