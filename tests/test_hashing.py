...
class TestHashing(unittest.TestCase):
    ...
    def test_update_hash_updates_capture(self):
        ...
        test_board = board.Board.of_string(
            "rnbqkbnr/p1pppppp/8/1p6/8/2N5/PPPPPPPP/R1BQKBNR w KQkq b5 0 3"  # TODO: should be b6
        )
        first_hash = hsh.zobrist_hash(test_board)
        test_move = "c3b5"
    ...
    def test_update_hash_updates_en_passant_capture(self):
        # ARRANGE
        test_board = board.Board.of_string(
            "rnbqkbnr/p1pppppp/8/8/Pp6/6PP/1PPPPP2/RNBQKBNR b KQkq a4 0 6"  # TODO: should be a3
        )
        first_hash = hsh.zobrist_hash(test_board)
        test_move = "b4a3"
